...
import Ease from "../components/easeofuse.svg"
import innovation from "../components/innovation.svg"
import comfoc from "../components/comfoc.svg"
          ...
          <BlurFade delay={0.25} inView key={item.title}>
            <div className="flex lg:items-center flex-col lg:flex-row gap-5 lg:h-[80vh]">
              <div className="lg:w-[50%]">
                ...
                <div className="md:text-4xl text-3xl mt-12 font-bold text-white">
                  {item.title}
                </div>
